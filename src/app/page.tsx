          ...
          <Grid className="h-full items-center relative">
            ...
            >
              <div className="relative w-full h-full overflow-hidden rounded-sm filter contrast-[1.05] saturate-[1.1] transition-all duration-1000">
                ...
                {/* Image Grain Texture (very subtle) */}
                <div className="absolute inset-0 bg-grain opacity-10 mix-blend-overlay pointer-events-none" />
                
                {/* Heavy Vignette to darken room background and focus on face */}
                ...
                {/* Clean Edge Fades to blend perfectly into background */}
          ...
          <Grid>
            ...
            <div className="col-span-4 md:col-span-5 lg:col-span-8">
              ...
              <div className="grid md:grid-cols-2 gap-8 text-muted-foreground text-lg">
                <p>
                  With a background in both structural problem solving and visual aesthetics, I bridge the gap between complex business requirements and seamless user experiences.
                </p>
                <p>
                  I don't just design screens; I build scalable design systems and craft cinematic experiences that convert users into loyal customers.
                </p>
              </div>
        ...
        <Container size="full" className="px-4 md:px-8 lg:px-12">
          ...
          <div className="grid md:grid-cols-12 gap-8 md:gap-12">
            ...
            <div className="md:col-span-7 group cursor-pointer">
              <div className="relative aspect-[4/3] mb-6 overflow-hidden bg-secondary rounded-xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[#111] to-[#050505] flex items-center justify-center border border-border/50 rounded-xl">
                  <span className="text-muted-foreground/30 font-heading text-4xl">Project Mockup</span>
                </div>
              </div>
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-2xl font-heading font-medium mb-2 group-hover:text-primary transition-colors">Fintech Dashboard</h4>
                  <p className="text-muted-foreground">UX Research, UI Design, Design System</p>
                </div>
            ...
            {/* Project 2 - Smaller Right */}
            <div className="md:col-span-5 md:mt-32 group cursor-pointer">
              <div className="relative aspect-square mb-6 overflow-hidden bg-secondary rounded-xl">
                <div className="absolute inset-0 bg-primary/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10 mix-blend-overlay" />
                {/* Placeholder Image */}
                <div className="absolute inset-0 bg-gradient-to-bl from-[#111] to-[#050505] flex items-center justify-center border border-border/50 rounded-xl">
                  <span className="text-muted-foreground/30 font-heading text-3xl">App Mockup</span>
                </div>
              </div>
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-2xl font-heading font-medium mb-2 group-hover:text-primary transition-colors">Health Tracking App</h4>
        ...
        <Container>
          <Grid>
            <div className="col-span-4 md:col-span-4 lg:col-span-5">
              ...
              <h3 className="text-4xl md:text-5xl font-heading font-medium leading-tight mb-8">
                Capabilities & <br/>Experience
              </h3>
              ...
              <div className="mt-12 flex items-start">
                <a href="https://drive.google.com/file/d/1TNIBfINEXBhwS9_lPxeRip0PMZ7LPidU/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                  <MagneticButton 
                    variant="ghost" 
                    className="px-8 py-4 border border-border/50 text-xs font-semibold tracking-widest uppercase gap-2 group/btn"
                  >
              ...
              <div className="flex flex-col gap-12">
                {[
                  { 
                    ...
                    period: "2025 - Present", 
                    desc: "Designing user-centered web and mobile experiences with a focus on usability, structure, and modern visual systems. Building complete UX case studies and scalable interfaces for digital products." 
                  },
                  { 
                    role: "UI/UX Competition Finalist", 
                    company: "Pixels Perfect Competition", 
                    period: "2025", 
                    desc: "Ranked among top participants in a competitive UI/UX challenge focused on landing page and product experience design. Created high-fidelity interfaces and interactive user flows." 
                  },
                  { 
                    role: "UI/UX Trainee", 
                    company: "Digital Egypt Pioneers Initiative (DEPI)", 
                    period: "2025 - 2026", 
                    desc: "Participating in intensive UX/UI training focused on user research, wireframing, prototyping, usability, and product thinking while developing real-world UX case studies." 
                  },
                  { 
                    role: "UX/UI Learning Journey", 
                    company: "Google UX & Industry Courses", 
                    period: "2024 - Present", 
                    desc: "Studying UX research, accessibility, interaction design, wireframing, and user-centered methodologies through Google UX certifications and practical product design projects." 
                  }
                ].map((job, i) => (
            ...
            <div className="col-span-4 md:col-span-8 lg:col-span-12 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16">
              ...
              <Link href="#journal" className="group block">
                ...
                <div className="flex flex-col gap-3 pr-4">
                  ...
                  <h4 className="text-2xl lg:text-3xl font-heading font-medium group-hover:text-primary transition-colors leading-tight">
                    The Architecture of Trust: Designing High-Conversion Fintech Interfaces
                  </h4>
                  <p className="text-muted-foreground/80 line-clamp-2 mt-2 leading-relaxed">
                    An in-depth breakdown of how spatial layout, typography, and micro-interactions directly impact user trust and conversion rates in financial products.
                  </p>
                </div>
              </Link>
              ...
              <Link href="#journal" className="group block md:mt-24">
                ...
                <div className="flex flex-col gap-3 pr-4">
                  ...
                  <h4 className="text-2xl lg:text-3xl font-heading font-medium group-hover:text-primary transition-colors leading-tight">
                    Beyond Aesthetics: Why Modern Startups Need Scalable Design Systems
                  </h4>
                  <p className="text-muted-foreground/80 line-clamp-2 mt-2 leading-relaxed">
                    A practical guide to building design systems that don't just look good, but actually accelerate engineering velocity and ensure long-term product consistency.
                  </p>
                </div>
              </Link>
