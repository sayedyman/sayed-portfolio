...
export default function ProjectsPage() {
  ...
  const filters = ["All", "SaaS", "Mobile", "Landing Pages", "Dashboards"];
  ...
  const projects = [
    {
      ...
      tags: ["Dashboard", "SaaS"],
      description: "Simplifying financial workflows for modern banking users through clear data hierarchy and intuitive architecture.",
      imageGradient: "from-[#111] via-[#161616] to-[#050505]",
      align: "left",
    },
    {
      id: 2,
      ...
      tags: ["Mobile", "UX"],
      description: "Empowering users with actionable health insights through seamless daily logging and thoughtful data visualization.",
      imageGradient: "from-[#0a0a0a] via-[#111] to-[#050505]",
      align: "right",
    },
    {
      id: 3,
      ...
      description: "Transforming complex enterprise datasets into clear, strategic business intelligence with scalable UI patterns.",
      imageGradient: "from-[#050505] via-[#111] to-[#0a0a0a]",
      align: "left",
    },
    {
      id: 4,
      ...
      tags: ["Landing Pages", "UX"],
      description: "Elevating the digital storefront with frictionless checkout flows and an immersive, premium product discovery experience.",
      imageGradient: "from-[#111] via-[#0a0a0a] to-[#050505]",
      align: "right",
    }
  ];
              ...
              <Grid>
                <div className={`col-span-4 md:col-span-8 lg:col-span-10 ${project.align === 'right' ? 'lg:col-start-3' : ''}`}>
                  ...
                  <div className="relative w-full aspect-[4/3] md:aspect-[16/9] overflow-hidden rounded-sm bg-secondary mb-8 md:mb-12">
                    ...
                    <motion.div 
                      className={`absolute inset-0 bg-gradient-to-br ${project.imageGradient}`}
