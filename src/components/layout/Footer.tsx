...
export function Footer() {
  return (
    <footer className="relative bg-background overflow-hidden border-t border-border pt-16 md:pt-24 pb-[calc(env(safe-area-inset-bottom)+3rem)]">
      <Container>
        <Section reveal={true} padding="none">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-end justify-between gap-6 md:gap-0 text-sm text-muted-foreground text-center md:text-left pt-8 border-t border-border/50">
