          ...
          <div className="col-span-4 md:col-span-4 lg:col-span-6 lg:col-start-7 mt-16 md:mt-0">
            <div className="flex flex-col gap-12">
              {[
                ...
                { role: "UX/UI Education & Certifications", company: "Google UX & Industry Courses", period: "2024 - Present", desc: "Studying UX research, accessibility, interaction design, wireframing, and user-centered methodologies through Google UX certifications and practical product design projects." }
              ].map((job, i) => (
