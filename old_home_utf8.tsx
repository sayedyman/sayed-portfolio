    ...
    <>
      ...
      <Section id="work" padding="xl">
        <Container size="full" className="px-4 md:px-8 lg:px-12">
          ...
          {/* Project Grid - Asymmetrical ΓÇö pure presentational, no async */}
        ...
        <Container>
          <Grid>
            <div className="col-span-4 md:col-span-4 lg:col-span-5">
              <h2 className="text-sm tracking-widest text-muted-foreground uppercase mb-4">/ 03 ΓÇö Expertise</h2>
        ...
        <Container>
          <Grid>
            <div className="col-span-4 md:col-span-8 lg:col-span-12 mb-24">
              <h2 className="text-sm tracking-widest text-muted-foreground uppercase mb-4">/ 04 ΓÇö Services</h2>
        ...
        <Container>
          <Grid>
            <div className="col-span-4 md:col-span-8 lg:col-span-12 flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
              <div>
                <h2 className="text-sm tracking-widest text-muted-foreground uppercase mb-4">/ 05 ΓÇö Journal</h2>
